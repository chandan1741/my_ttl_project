//Job cart
$(document).on('click','.total_job_card',function(){
  var par_accnt_id = $('#p_ARN').val();
  // alert(par_accnt_id);
  state_wise_jc(par_accnt_id);
  lob_wise_jc(par_accnt_id);
  // detailed_job_cards(par_accnt_id);
  chassis_number(par_accnt_id);
  month_wise_job_cards(par_accnt_id);
  yrs(par_accnt_id);
...
$(document).on('click','.p_all_jc',function(){
  $("#container1").empty();
...
$(document).on('click','input[name="p_optionsRadios"]',function(){
  // alert('dd');
  var par_accnt_id = $('#p_ARN').val();
  // var par_accnt_id = $('#p_ARN').val();
  var status = $("input[name='p_optionsRadios']:checked").val();
  // alert(status);
   var csrfName = '<?php echo $this->security->get_csrf_token_name(); ?>',
        ...
        $.ajax({
              type: "POST",
                ...
                data:{[csrfName]: csrfHash,par_accnt_id:par_accnt_id,status:status},
                beforeSend: function() {
...
$(document).on('click','.p_open_jc',function(){
  // alert('dd');
  // $("#jc_data").empty();
  $('.yr_d').show();
  $('#container1_no_record').empty();
  ...
  var par_accnt_id = $('#p_ARN').val();
  chassis_number(par_accnt_id);
  var _open_jc = $('input[name=p_optionsRadios]:checked', '#r_from').val();
  lob_wise_open_jc(par_accnt_id,_open_jc);
   ...
   var csrfName = '<?php echo $this->security->get_csrf_token_name(); ?>',
        ...
        $.ajax({
              type: "POST",
                ...
                data:{[csrfName]: csrfHash,par_accnt_id:par_accnt_id,_open_jc:_open_jc},
                beforeSend: function() {
                $("#state_wise_jc_loading").show();
                },
                success: function(records){
...
// $("#closed_jc").click(function(){
  $(document).on('click','.p_closed_jc',function(){
    $('#container1_no_record').empty();
  $('#lob_wise_job_cards_no_record').empty();
  $('#month_wise_jc_chart_no_record').empty();
    // alert('dd');
  var par_accnt_id = $('#p_ARN').val();
  var closed_jc = $('input[name=p_ptionsRadios]:checked', '#r_from').val();
  lob_wise_closed_jc(par_accnt_id,closed_jc);
  // $("#jc_data").empty();
  $("#container1").empty();
  $("#month_wise_jc_chart").empty();
  $("#lob_wise_job_cards").empty();
  ...
  var csrfName = '<?php echo $this->security->get_csrf_token_name(); ?>',
        ...
        $.ajax({
              type: "POST",
                url: "jc/state_wise_jc",
                data:{[csrfName]: csrfHash,par_accnt_id:par_accnt_id,closed_jc:closed_jc},
                beforeSend: function() {
                $("#state_wise_jc_loading").show();
                },
                success: function(records){
...
function state_wise_jc(par_accnt_id){
  var csrfName = '<?php echo $this->security->get_csrf_token_name(); ?>',
            csrfHash = '<?php echo $this->security->get_csrf_hash(); ?>';
        $.ajax({
              type: "POST",
...
function month_wise_job_cards(par_accnt_id){
...
function lob_wise_jc(par_accnt_id){
  var csrfName = '<?php echo $this->security->get_csrf_token_name(); ?>',
            csrfHash = '<?php echo $this->security->get_csrf_hash(); ?>';
            $.ajax({
              type: "POST",
...
function lob_wise_open_jc(par_accnt_id,open_jc){
  var csrfName = '<?php echo $this->security->get_csrf_token_name(); ?>',
            csrfHash = '<?php echo $this->security->get_csrf_hash(); ?>';
            $.ajax({
              type: "POST",
                url: "jc/lob_wise_jc",
                data:{[csrfName]: csrfHash,par_accnt_id:par_accnt_id,open_jc:open_jc},
                beforeSend: function() {
                $("#lob_wise_job_cards_loading").show();
                },
                success: function(records){
...
function lob_wise_closed_jc(par_accnt_id,closed_jc){
  var csrfName = '<?php echo $this->security->get_csrf_token_name(); ?>',
            csrfHash = '<?php echo $this->security->get_csrf_hash(); ?>';
            $.ajax({
              type: "POST",
...
function detailed_job_cards(par_accnt_id) {
           var csrfName = '<?php echo $this->security->get_csrf_token_name(); ?>',
            csrfHash = '<?php echo $this->security->get_csrf_hash(); ?>';
            $.ajax({
              type: "POST",
...
function chassis_number(par_accnt_id) {
 var csrfName = '<?php echo $this->security->get_csrf_token_name(); ?>',
            csrfHash = '<?php echo $this->security->get_csrf_hash(); ?>';
            $.ajax({
              type: "POST",
...
$(document).on('change','.jc_chassis_num_p',function(){
// $("jc_chassis_num_p").change(function() {
  ...
  var status = $('input[name=p_optionsRadios]:checked', '#r_from').val();

  // alert(status);
            $.ajax({
              type: "POST",
                url: "jc/search_chassis_number",
                data:{[csrfName]: csrfHash,par_accnt_id:par_accnt_id,chassis_number:chassis_number,status:status},
                beforeSend: function() {
                $("#detailed_job_cards_loading").show();
                },
                success: function(records){
              ...
              // console.log(sta,limit);
                    var e = 0;
                        for(var i=sta;i<limit;i++){
                          e++;
                        // var d = new Date(userDetails[i].JC_CREATED_DT_STR);
                        
                        // console.log(d);
                        // var formattedDate =  d.getDay()+ "-" + d.getMonth()+1;
...
$('#jc_yrs').change(function(){
  ...
  var status = $('input[name=optionsRadios]:checked', '#r_from').val();
              $.ajax({
                  ...
                  data:{[csrfName]: csrfHash,par_accnt_id:par_accnt_id,yrs:yrs,status:status},
                  beforeSend: function() {
                  $("#month_wise_jc_loading").show();
                  },
                  success: function(records){
