...
(h._creditLink=document.createElement("a"),h._creditLink.setAttribute("class","canvasjs-chart-credit"),h._creditLink.setAttribute("title",""),h._creditLink.setAttribute("style","top:"+(h.height-14)+"px;"),h._creditLink.setAttribute("tabIndex",-1),h._creditLink.setAttribute("target",""));if(0===h.renderCount||
