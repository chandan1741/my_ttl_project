...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="nav-tabs-custom" style="height: 490px;">
            ...
            <div class="tab-content">
              ...
              <div style="text-align: center;">
                  ...
                  <!-- <a href="#" name="cvbu_btn" id="cvbu_btn" data="All" style="text-decoration: none;" class="btn btn btn-info flat pull-center" disabled>CVBU Customer 360  <i class="fa fa-paper-plane" aria-hidden="true"></i></a> -->
        ...
        <!-- /#fa-icons -->
              ...
              <div class="tab-pane" id="glyphicons">
                ...
                <div id="_data" style="display: none;"></div>
                  <!-- </div> -->
                  <div class="callout callout-info" style="height: 165px;">
                  <div class="col-md-12">
                ...
                <div class="callout callout-info jc_service">
                  <div class="col-md-12">
                    ...
                    <div class="col-md-6 col-xs-12 vl4">
                      <div class="small-box" style="background-color: #fff;margin-top: 58px;"> 

                    <div class="col-md-6 col-xs-12" style="background-color: #948060;height: 70px;" >
                        <a href="javascript:void(0);" id="total_job_card" title="Click here" style="text-decoration: none;"><h4 style="text-align: center;">Total JC</h4>
                        <strong><p style="color: #fff; text-align: center;font-size: 1em;margin-top: 25px;font-family: 'Orbitron', sans-serif;" id="total_jc"> 0</p></strong></a>
                      ...
                      <div class="col-md-12" style="background-color: #17a2b8; height: 70px;">
                   ...
                   <div class="col-md-6 col-xs-12 ">
                     ...
                     <div class="small-box" style="background-color: #fff;">
                      ...
                      <div class="col-md-6" style="background-color: #00c0ef;height: 70px;" >
                        <h4 style="text-align: center;">Avg Resoulation Days</h4>
...
<!------------------------------------------------------------Job Card Details---------------------------->
              ...
              <div class="tab-pane" id="glyphicons2">
                <section id="new">
                  ...
                  <div class="callout callout-info comp">
                  <div class="col-md-12">
                    <h4 style="text-align: center;">Job Card Details</h4>
                  </div>
                </div>
                <div class="col-md-12">
                   <div class="col-lg-3 col-xs-6">
                  ...
                  <div class="box-body table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="background-color: #fff; padding: 0px; margin-top: 0%; width: 100%; margin-left: 0px;">
                      ...
                      <p id="bg-text9" style="text-align: center;"><?php echo $this->session->userdata('ip');?></p>
                       <p id="bg-text9" style="text-align: center;"><?php echo date('d-m-Y H:i:s');?></p>
                        ...
                        <!-- <div style="text-align: center;" >
                       <img id="detailed_job_cards_loading"  src="<?php echo base_url();?>assets/img/spinner.gif" style="display:none;height: 90px;width: 23%;"/>
                       </div> -->
