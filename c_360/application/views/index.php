        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom" style="height: 495px;">
            <ul id="myTab" class="nav nav-tabs">
              ...
              <li><a href="#glyphicons" id="t2" class="disabled">Customer Details</a></li>
              ...
              <?php //echo $this->uri->segment(2);die;?>
          ...
          <?php } ?>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="fa-icons">
                <section id="new" >
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                      <div class="input-group">
                        <span class="input-group-addon" title="Search Not Merge Records">
                          <input type="checkbox" name="g_record" id="g_record" value="true" title="Search Not Merge Records">
                        </span>
              ...
              <div style="text-align: center;">
                  ...
                  <button type="button" name="cvbu_btn" id="cvbu_btn" data="All" class="btn btn btn-info flat pull-center" value="CVBU Customer 360" disabled>Click here <i class="fa fa-paper-plane" aria-hidden="true"></i> </button>
        ...
        <!-- /#fa-icons -->
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-4 col-xs-6 f1">
                    	<div class="img-responsive pull-left">
                  		<img src="<?php echo base_url();?>assets/img/spaqplug_logo.png" style="width: 68%;margin-left: -42%;">
                  	</div>
                     <!-- <div>
                    <img src="<?php echo base_url();?>assets/img/spaqplug_logo.png" style="width: 20%;margin-left: -13%;">
                    </div> -->
                    </div>
                    ...
                    <img src="<?php echo base_url();?>assets/img/tata_it_logo (2).png" style="width: 103%;margin-left: 23%;margin-top: 8%;">
                    </div>
                    </div>
              ...
              <text id="lost_Qty" x="50" y="50" text-anchor="middle" dy="7" font-size="20">0</text>
                ...
                <div id="_data" style="display: none;"></div>
                  <!-- </div> -->
                  <div class="callout callout-info" style="height: 180px;">
                    <div class="row">
                      <div class="col-md-6">
                        <a href="javascript:void(0);" title="click here" id="data_model" style="text-decoration: none;"><i class="fa fa-info-circle" aria-hidden="true"></i> Click here for current pipeline details</a>
                      </div>
                      <div class="col-md-6">
                        <div>
                      <a href="javascript:void(0);" id="total_job_card" class="total_job_card"  title="Click here" style="text-decoration: none;"><i class="fa fa-info-circle" aria-hidden="true"></i> Click here to view JC details</a>
                    </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-12">
                      ...
                      <h4 style="text-align: center;">Open Pipeline</h4>
                      <div style="text-align: center;"><svg id="animated" viewbox="0 0 100 100" style="width: 70%;">
                  <circle cx="50" cy="50" r="45" fill="#FDB900"/>
                  <path id="progress" stroke-linecap="round" stroke-width="5" stroke="#fff" fill="none"
                        d="M50 10
                           a 40 40 0 0 1 0 80
              ...
              <text id="open_pipeline" x="50" y="50" text-anchor="middle" dy="7"  style="color: #000;font-size: 22px;">0</text>
              ...
              <text id="direct_billing" x="50" y="50" text-anchor="middle" dy="7"  style="color: #000;font-size: 22px;">0</text>
                    ...
                    <div class="col-md-6 col-xs-12 vl5">
                    ...
                    <div class="col-md-6 col-xs-12" style="background-color: #948060;height: 70px;" >
                      ...
                      <div class="col-md-6 col-xs-12" style="background-color: #3d8488b8;height: 70px;" >
                        <h4 style="text-align: center;">Total Vehicle</h4>
                        <strong><p style="color: #fff; text-align: center;font-size: 1em;margin-top: 25px;font-family: 'Orbitron', sans-serif;" id="t_v"> 0</p></strong>
                      ...
                      <div class="col-md-6" style="background-color: #3385b5; height: 70px;">
                      ...
                      <div class="col-md-6 col-xs-12" style="background-color: #dd4b398a;height: 70px;" >
...
<!------------------------------------------------------Total Complaints Details------------------------>
              ...
              <div id="state_complaints_no_record"></div>
              <div id="state_complaints"></div>
                ...
                <div id="chartdiv"></div>
                  ...
                  <div class="box-body table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="padding: 0px;margin-top: 30px; width: 117%; margin-left: -19px;">
                      <!-- <div id="background_ip1">
                      <p id="bg-text1" style="text-align: center;"><?php echo $this->session->userdata('user_name');?></p>
                      <p id="bg-text1" style="text-align: center;"><?php echo $this->session->userdata('ip');?></p>
                       <p id="bg-text1" style="text-align: center;"><?php echo date('d-m-Y H:i:s');?></p>
...
<!------------------------------------------------------------Job Card Details---------------------------->
              ...
              <div class="tab-pane" id="glyphicons2">
                <section id="new">
                  <!-- <h4 class="page-header">Customer 360&#xb0;</h4> -->
<div class="callout callout-info comp" style="height: 95px;position: fixed;z-index: 1;width: 96%;margin-bottom: 51px;">
                  <div class="col-md-12">
                  	<div class="col-md-4">
                  		<!-- <div style="width: 20%;margin-left: -13%;margin-top: -12px;"> -->
                  		<div class="img-responsive pull-left">
                  		<img src="<?php echo base_url();?>assets/img/spaqplug_logo.png" style="width: 68%;margin-left: -42%;">
                  	</div>
                  	</div>
                      ...
                      <span><strong>Golden Account:</strong></span>
                      <span id='g_account_name_j'></span><br>
                        <span id='g_account_arn_num_j'></span><br>
                      <span><strong>Child Account:</strong></span>
                      <span id="g_chil_name_j"></span><br>
                        <span id="g_chil_arn_num_j"></span>
                  	</div>
                  	<div class="col-md-4">
                  		<div class="pull-right" style="text-align: center;">
                    <img src="<?php echo base_url();?>assets/img/tata_it_logo (2).png" style="margin-left: 24%;">
                  </div>
                  	</div>
              ...
              <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-black"style="height: 103px;">
                  <div class="inner">
                    ...
                    <div class="form-group" style="margin-top: -15px;">
                      <div class="radio">
                        <label>
                          <input type="radio" name="optionsRadios" class="c_all_jc" id="all_jc" value="all_jc" checked>
                         All
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="optionsRadios" id="_open_jc" class="c_open_jc" value="open_jc">
                          Open JC
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="optionsRadios" id="closed_jc" class="c_closed_jc" value="closed_jc">
                          Closed JC
                        </label>
                      </div>
                    </div>
                    ...
                    <!-- <div id="background_ip_jc">
                      ...
                      <p id="bg-text3" style="text-align: center;"><?php echo $this->session->userdata('ip');?></p>
                       <p id="bg-text3" style="text-align: center;"><?php echo date('d-m-Y H:i:s');?></p>
                        ...
                        <div id="container1_no_record"></div>
                <div id="container1">
                  <div style="text-align: center;">
                  ...
                  <div class="form-group yr_d" style="margin-top: 36px;margin-left: -7px;">
                      <select class="form-control select3" name="jc_yrs" id="jc_yrs">
                        ...
                        <div id="month_wise_jc_chart_no_record"></div>
                ...
                <div id="lob_wise_job_cards_no_record"></div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="row" style="margin-top: 2%">
                      ...
                      <div class="col-md-4">
                      <div class="form-group">
                      <select class="form-control select2 jc_chassis_num_p" name="jc_chassis_num_p" id="jc_chassis_num">
                  ...
                  <div class="box-body table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="padding: 0px; margin-top: 0%; width: 100%; margin-left: 0px;">
                    <div style="text-align: center;" >
...
<script src="<?php echo base_url();?>assets/js/jc_child.js"></script>
...
//--------------------------------------------------li Click-----------------------------------------------
  ...
  // var ZZZ = $(this).attr("account_name");
  // var account_name = ZZZ.split("_").join(" ");
  // alert(account_name);
  var accnt_name = $(this).attr("accnt_name");
  // alert(accnt_name);
  // var ZZZ = $(this).attr("accnt_name");
  // var accnt_name = ZZZ.split("_").join(" ");
  // alert(accnt_name);
  ...
  $('#g_account_name_j').text($.trim(accnt_name));

  $('#p_ARN').val($.trim(p_id));
  $('#p_id').text($.trim(p_id));
  $('#g_account_arn_num').text($.trim(p_id));
  $('#g_account_arn_num_j').text($.trim(p_id));
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#glyphicons2').bind('cut copy paste', function (e) {
        e.preventDefault();
    });

    $('#glyphicons').bind('cut copy paste', function (e) {
        e.preventDefault();
    });
   
    //Disable mouse right click
    $("#glyphicons").on("contextmenu",function(e){
        return false;
    });
    ...
    $('#cvbu_btn,#t2').click(function(e){
      e.preventDefault();
       $('.total_job_card_child').addClass('total_job_card').removeClass('total_job_card_child');
       $('.jc_chassis_num_c').addClass('jc_chassis_num_p').removeClass('jc_chassis_num_c');
       $('.c_all_jc').addClass('p_all_jc').removeClass('c_all_jc');
	    $('.c_open_jc').addClass('p_open_jc').removeClass('c_open_jc');
	    $('.c_closed_jc').addClass('p_closed_jc').removeClass('c_closed_jc');
	    $("#_open_jc").attr("name","p_optionsRadios");
	    $("#closed_jc").attr("name","p_optionsRadios");
	    $("#all_jc").attr("name","p_optionsRadios");
       $("#jc_data").empty();
      ...
      // alert(par_accnt_id);
      $('#g_chil_name_j').text(data);
      $('#g_chil_name').text(data);
      $('#g_chil_arn_num').text(data);
      $('#g_chil_arn_num_j').text(data);
...
<script type="text/javascript">
  //Child data get----------------------------------------------------/////////////////////////////////
    $('body').on('click','.view',function(e){
      ...
      var ZZZ = $(this).attr('data');
      var name = ZZZ.split("_").join(" ");
      // alert(ZZZ2);
      ...
      $('#g_chil_name_j').text(name);
      $('#g_chil_arn_num').text(arn);
      $('#g_chil_arn_num_j').text(arn);
...
<script type="text/javascript">
    ...
    function info(){
      ...
      var lost_qty = $('#cp').val();
      var c3 = $('#c3').val();
      var total_open_pipeline = c0+c1+c2+c1a;

      
      if(isNaN(total_open_pipeline)) {

      	$('#open_pipeline').text('0');

      }else{
      	$('#open_pipeline').text(total_open_pipeline);
      }
...
<script type="text/javascript">
  ...
  $(document).on('click','.view',function(){
    $('.total_job_card').addClass('total_job_card_child').removeClass('total_job_card');
    $('.p_all_jc').addClass('c_all_jc').removeClass('p_all_jc');
    $('.p_open_jc').addClass('c_open_jc').removeClass('p_open_jc');
    $('.p_closed_jc').addClass('c_closed_jc').removeClass('p_closed_jc');
    $('.jc_chassis_num_p').addClass('jc_chassis_num_c').removeClass('jc_chassis_num_p');
    $("#_open_jc").attr("name","c_optionsRadios");
    $("#closed_jc").attr("name","c_optionsRadios");
    $("#all_jc").attr("name","c_optionsRadios");
    // alert('total_job_card');
  });
</script>
</body>
</html>
